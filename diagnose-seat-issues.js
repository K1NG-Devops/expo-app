...
async function diagnose() {
  ...
  try {
    ...
    console.log('❌ Exception checking subscriptions:', e.message);
  }
  ...
  try {
    ...
    console.log('❌ Exception checking subscription_seats:', e.message);
  }
  ...
  try {
    ...
    console.log('❌ Exception checking users table:', e.message);
  }
  ...
  try {
    ...
    console.log('❌ Exception checking profiles table:', e.message);
  }
  ...
  try {
    ...
    console.log('❌ Exception checking preschools table:', e.message);
  }
  ...
  try {
    ...
    console.log('❌ Exception checking subscription_plans table:', e.message);
  }
  ...
  try {
    ...
    console.log('   ❌ Exception testing queries:', e.message);
  }
