-- Quick fix for teacher dashboard access issues - V2

-- 1. Drop existing function first
DROP FUNCTION IF EXISTS get_my_org_member(uuid);

-- 2. Create the get_my_org_member RPC with correct return type
...
-- 4. Disable RLS on assignments temporarily (to fix 400 errors)
...
-- EXPECTED RESULTS:
-- 1. Function recreated successfully
-- 2. RPC should return seat_status: 'active' for the teacher
-- 3. Assignments 400 errors should stop
-- 4. Teacher dashboard should unlock