...
async function diagnosePrincipalDashboard() {
  ...
  for (const schoolId of schoolIds) {
    ...
    try {
      ...
      console.log(`   ❌ Could not fetch school details: ${e.message}`);
    }
    ...
    try {
      ...
      console.log(`   ❌ Subscription query failed: ${e.message}`);
    }
    ...
    try {
      ...
      console.log(`   ❌ Broad subscription query failed: ${e.message}`);
    }
  }
