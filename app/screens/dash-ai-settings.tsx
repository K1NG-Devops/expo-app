        ...
        <View style={[styles.card, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          ...
          <View style={[styles.settingRow, { borderBottomColor: theme.border }]}>
            <View style={styles.settingInfo}>
              ...
              <View style={[styles.warningBox, { backgroundColor: `${theme.success}20`, borderColor: theme.success, marginTop: 8 }]}>
                <Text style={[styles.warningText, { color: theme.success }]}>✅ Picovoice configured! Custom wake word "Hello Dash" ready to use.</Text>
              </View>
            </View>
            <Switch
