...
export default function PricingPage() {
  ...
  // Filter out free plans for logged-in users (they're upgrading, not starting fresh)
  const displayedPlans = isLoggedIn 
    ? activePlans.filter(plan => plan.price !== 0)
    : activePlans;
      ...
      <div style={{ minHeight: "100vh", background: "#0a0a0f", color: "#fff", fontFamily: "system-ui, sans-serif" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px 40px" }}>
          ...
          <div style={{ 
            ...
            gap: "24px",
            maxWidth: userType === "schools" && displayedPlans.length === 4 ? "1200px" : "900px",
            margin: "0 auto"
          }}>
            {displayedPlans.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <Link 
                    href={isLoggedIn ? "/dashboard/parent/settings" : "/sign-in"}
                    style={{
                      display: "block",
                      width: "100%",
                      padding: "14px",
