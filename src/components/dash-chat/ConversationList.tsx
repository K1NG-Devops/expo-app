...
export function ConversationList({ 
  ...
  const loadConversations = async () => {
    try {
      ...
      if (error) {
        console.warn('Supabase query failed (table may not exist yet):', error.message || error);
        setConversations([]);
        return;
      }
      ...
      console.warn('Error loading conversations (non-fatal):', error instanceof Error ? error.message : error);
      setConversations([]);
    } finally {
      setLoading(false);
    }
