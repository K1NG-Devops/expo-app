...
interface ParentShellProps {
  ...
  // New optional header slots
  headerChildren?: React.ReactNode;
  headerActionsRight?: React.ReactNode;
  // New: hide the brand chip (EduDash Pro) to free space
  showBrandChip?: boolean;
}

export function ParentShell({ tenantSlug, userEmail, userName, preschoolName, unreadCount = 0, hasOrganization: hasOrganizationProp, children, headerChildren, headerActionsRight, showBrandChip = true }: ParentShellProps) {
      ...
      <header className="topbar">
        <div className="topbarRow topbarEdge">
          <div className="leftGroup">
            ...
            {/* Brand chip (can be hidden via prop) */}
            {showBrandChip && (
              preschoolName ? (
            ...
            {/* Page-specific header content injected here */}
            {headerChildren && (
          ...
          <div className="rightGroup" style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
